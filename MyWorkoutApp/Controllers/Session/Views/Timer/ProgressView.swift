...
extension TimerView {
    final class ProgressView: UIView {
        ...
        func drawProgress(with percent: CGFloat) {
            //что бы анимация заполнения не дергалась
            ...
            let defaultsCircleLayer = CAShapeLayer()
            defaultsCircleLayer.path = circlePath.cgPath
            defaultsCircleLayer.strokeColor = Resources.Colors.separator.cgColor
            defaultsCircleLayer.lineWidth = 20
            defaultsCircleLayer.strokeEnd = 1
            defaultsCircleLayer.fillColor = UIColor.clear.cgColor
            defaultsCircleLayer.lineCap = .round
            
            let circleLayer = CAShapeLayer()
            circleLayer.path = circlePath.cgPath
            circleLayer.strokeColor = Resources.Colors.actiy.cgColor
            ...
            bigDotLayer.strokeColor = Resources.Colors.actiy.cgColor
            ...
            (1...9).forEach { _ in
                ...
                ? Resources.Colors.actiy.cgColor : Resources.Colors.separator.cgColor
            ...
            layer.addSublayer(defaultsCircleLayer)
